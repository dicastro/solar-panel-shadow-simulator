...
interface Props {
  ...
  timezone: string;
  /** Calendar year of the simulation run, used for UTC offset calculation. */
  year: number;
}
 ...
 */
export function DailyLineChart({ results, activeSetupIds, month, day, timezone, year }: Props) {
